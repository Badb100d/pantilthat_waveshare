...
# ============================================================================
# servo1: 0-180  servo2: 0-140

SLEEP_TIME = 0.05

class pantilthat_cls:
    def __init__(self):
        self.pwm = PCA9685()
    ...
    def servo_enable(self, num, enable):
        pass

    def pan(self, angle):
        self.pwm.setRotationAngle(self.pan_no, angle+90)
        sleep(SLEEP_TIME)
    def tilt(self, angle):
        if 0 >= angle:
            self.pwm.setRotationAngle(self.tilt_no, angle+90)
            sleep(SLEEP_TIME)
    def __del__(self):
